...
- **Google OAuth Login**: Secure authentication for both Students and Admins.
- **Admin Dashboard**: Start/End sessions, generate secure 6-digit OTPs, view live attendance, and export data as CSV.
