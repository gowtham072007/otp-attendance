      ...
      <main className="max-w-4xl mx-auto mt-8 p-4 w-full grid gap-8 md:grid-cols-5 flex-1">
        ...
        <div className="md:col-span-3 space-y-6">
          <div className="bg-white dark:bg-zinc-900/90 p-8 rounded-3xl shadow-sm border border-zinc-200 dark:border-zinc-800">
            <div className="inline-flex items-center space-x-2 px-3 py-1 bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-800 dark:text-zinc-300 text-[11px] font-mono uppercase tracking-wider rounded-full mb-3">
            ...
            {status.message && (
              <div className={`p-4 rounded-2xl mb-8 flex items-start space-x-3 text-sm font-medium ${status.type === 'success' ? 'bg-zinc-100 dark:bg-zinc-800/80 text-zinc-900 dark:text-zinc-100 border border-zinc-300 dark:border-zinc-700' : 'bg-red-50 dark:bg-red-950/60 text-red-700 dark:text-red-300 border border-red-200 dark:border-red-900/50'}`}>
                {status.type === 'success' ? <CheckCircle className="shrink-0 mt-0.5 text-black dark:text-white" size={18} /> : <AlertCircle className="shrink-0 mt-0.5" size={18} />}
                <p>{status.message}</p>
              </div>
            )}
